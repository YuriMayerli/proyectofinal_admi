                    ...
                    <div className="card">
                        <div className="card-header">
                            <h3 className="card-title">
                                <Link to={"/clientes/agregar"} className="btn btn-block btn-primary btn-sm">Agregar</Link>
                            </h3>
                                    ...
                                    {clientes.map((cliente, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>
                                                ...
                                                <button onClick={(e) => eliminarCliente(e, cliente._id)} className='btn btn-sm btn-danger'>Borrar</button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
